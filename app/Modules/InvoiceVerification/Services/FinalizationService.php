...
class FinalizationService
{
    ...
    {
        $transaction->loadMissing('invoiceMetadata', 'vendor', 'latestDocuments.documentType', 'generatedDocuments', 'ppaVerificationSheet', 'memoRequest', 'agreementReference', 'division', 'department.users');
