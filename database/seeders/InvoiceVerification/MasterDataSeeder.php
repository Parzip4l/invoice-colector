...
class MasterDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $types = collect([
            ['code' => TransactionTypeCode::PPA, 'name' => 'Persetujuan Penggunaan Anggaran', 'upload_scheme' => UploadScheme::PPA_DETAILED],
        ...
        $documentTypes = [
            ...
            ['transaction_type' => TransactionTypeCode::KAS_KECIL, 'code' => DocumentCode::KAS_KECIL_COMBINED_VENDOR, 'name' => 'Dokumen Vendor Kas Kecil', 'source_type' => DocumentSourceType::VENDOR, 'upload_mode' => DocumentUploadMode::COMBINED_FORM, 'approval_mode' => ApprovalMode::NONE, 'is_required' => false, 'sort_order' => 2],
        ];
