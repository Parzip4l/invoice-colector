...
class MasterDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $documentTypes = [
            ...
            ['transaction_type' => TransactionTypeCode::PPA, 'code' => DocumentCode::PPA_LAMPIRAN_PEKERJAAN, 'name' => 'Lampiran Pekerjaan', 'source_type' => DocumentSourceType::VENDOR, 'upload_mode' => DocumentUploadMode::SINGLE_SLOT, 'approval_mode' => ApprovalMode::NONE, 'is_required' => false, 'sort_order' => 10],
            ['transaction_type' => TransactionTypeCode::PPA, 'code' => DocumentCode::PPA_LAPORAN_PEKERJAAN, 'name' => 'Laporan Pekerjaan', 'source_type' => DocumentSourceType::VENDOR, 'upload_mode' => DocumentUploadMode::SINGLE_SLOT, 'approval_mode' => ApprovalMode::NONE, 'is_required' => false, 'sort_order' => 11],
