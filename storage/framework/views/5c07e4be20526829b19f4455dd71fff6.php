     ...
     <div class="container-fluid">
          <div class="navbar-header">
               <div class="d-flex align-items-center gap-3">
                    ...
                    <form class="app-search d-none d-md-block me-auto" action="<?php echo e(route('invoice-verification.transactions.index')); ?>" method="GET">
                         ...
                         <a type="button" class="topbar-button user-menu-button" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                              ...
                              <span class="d-flex align-items-center gap-2">
                                   <span class="topbar-user-avatar rounded-circle bg-primary-subtle text-primary d-inline-flex align-items-center justify-content-center fw-semibold">
                                        <?php echo e(str(auth()->user()?->name ?? 'U')->substr(0, 1)->upper()); ?>

                                   </span>
                                   <span class="d-none d-lg-block text-start">
                                        <span class="d-block fw-semibold lh-sm"><?php echo e(auth()->user()?->name); ?></span>
                                        <small class="text-muted"><?php echo e(auth()->user()?->role_code?->label() ?? auth()->user()?->role_code); ?></small>
                                   </span>
                              </span>
                         </a>
...
<?php /**PATH /Users/muhamadsobirin/Public/LRTJ App/invoice-colector/resources/views/layouts/partials/topbar.blade.php ENDPATH**/ ?>